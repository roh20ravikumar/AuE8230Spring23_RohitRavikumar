...
# this code basically runs the turtle with a linear velocity as well as an angular velocity 
# which makes it run in a circle
# input to the function is linear velocity and angular velocity
